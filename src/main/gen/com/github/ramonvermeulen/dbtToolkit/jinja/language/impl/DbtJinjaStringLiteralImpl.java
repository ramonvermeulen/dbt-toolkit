...
public class DbtJinjaStringLiteralImpl extends ASTWrapperPsiElement implements DbtJinjaStringLiteral {

  public DbtJinjaStringLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
