...
public class ManifestMetadata__1 implements Serializable
{

    @SerializedName("dbt_schema_version")
    @Expose
    private String dbtSchemaVersion = "https://schemas.getdbt.com/dbt/manifest/v10.json";
    @SerializedName("dbt_version")
    @Expose
    private String dbtVersion = "1.6.5";
    @SerializedName("generated_at")
    @Expose
    private Date generatedAt = new Date(1696465994410L);
    ...
    private final static long serialVersionUID = 8541911645840104050L;
    ...
    public Env__1 getEnv() {
        return env;
    }

    public void setEnv(Env__1 env) {
        this.env = env;
    }
    ...
    public String toString() {
        ...
        sb.append(ManifestMetadata__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ManifestMetadata__1) == false) {
            return false;
        }
        ManifestMetadata__1 rhs = ((ManifestMetadata__1) other);
