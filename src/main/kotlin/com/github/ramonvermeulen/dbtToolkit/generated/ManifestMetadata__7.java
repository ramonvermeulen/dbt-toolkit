...
public class ManifestMetadata__7 implements Serializable
{

    @SerializedName("dbt_schema_version")
    @Expose
    private String dbtSchemaVersion = "https://schemas.getdbt.com/dbt/manifest/v7.json";
    @SerializedName("dbt_version")
    @Expose
    private String dbtVersion = "1.3.0b2";
    @SerializedName("generated_at")
    @Expose
    private Date generatedAt = new Date(1664991685798L);
    ...
    private final static long serialVersionUID = -688845592406971720L;
    ...
    public Env__9 getEnv() {
        return env;
    }

    public void setEnv(Env__9 env) {
        this.env = env;
    }
    ...
    public String toString() {
        ...
        sb.append(ManifestMetadata__7 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ManifestMetadata__7) == false) {
            return false;
        }
        ManifestMetadata__7 rhs = ((ManifestMetadata__7) other);
