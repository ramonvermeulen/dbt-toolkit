...
public class ManifestMetadata implements Serializable
{
    ...
    @Expose
    private String dbtSchemaVersion = "https://schemas.getdbt.com/dbt/manifest/v1.json";
    @SerializedName("dbt_version")
    @Expose
    private String dbtVersion = "0.19.0";
    @SerializedName("generated_at")
    @Expose
    private Date generatedAt = new Date(1612932153683L);
    ...
    private final static long serialVersionUID = -4072412250817001251L;
    ...
    public String toString() {
        ...
        sb.append(ManifestMetadata.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ManifestMetadata) == false) {
            return false;
        }
        ManifestMetadata rhs = ((ManifestMetadata) other);
