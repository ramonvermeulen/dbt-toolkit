...
public class ManifestMetadata__3 implements Serializable
{

    @SerializedName("dbt_schema_version")
    @Expose
    private String dbtSchemaVersion = "https://schemas.getdbt.com/dbt/manifest/v3.json";
    @SerializedName("dbt_version")
    @Expose
    private String dbtVersion = "0.21.0rc1";
    @SerializedName("generated_at")
    @Expose
    private Date generatedAt = new Date(1632490154317L);
    ...
    private final static long serialVersionUID = -6259136535561817369L;
    ...
    public Env__5 getEnv() {
        return env;
    }

    public void setEnv(Env__5 env) {
        this.env = env;
    }
    ...
    public String toString() {
        ...
        sb.append(ManifestMetadata__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ManifestMetadata__3) == false) {
            return false;
        }
        ManifestMetadata__3 rhs = ((ManifestMetadata__3) other);
