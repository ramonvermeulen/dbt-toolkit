...
public class ManifestMetadata__6 implements Serializable
{

    @SerializedName("dbt_schema_version")
    @Expose
    private String dbtSchemaVersion = "https://schemas.getdbt.com/dbt/manifest/v6.json";
    @SerializedName("dbt_version")
    @Expose
    private String dbtVersion = "1.2.0";
    @SerializedName("generated_at")
    @Expose
    private Date generatedAt = new Date(1658840564173L);
    ...
    private final static long serialVersionUID = 2097612920639820689L;
    ...
    public Env__8 getEnv() {
        return env;
    }

    public void setEnv(Env__8 env) {
        this.env = env;
    }
    ...
    public String toString() {
        ...
        sb.append(ManifestMetadata__6 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ManifestMetadata__6) == false) {
            return false;
        }
        ManifestMetadata__6 rhs = ((ManifestMetadata__6) other);
