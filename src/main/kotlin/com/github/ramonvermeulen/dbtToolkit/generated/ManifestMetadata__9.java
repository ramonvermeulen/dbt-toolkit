...
public class ManifestMetadata__9 implements Serializable
{

    @SerializedName("dbt_schema_version")
    @Expose
    private String dbtSchemaVersion = "https://schemas.getdbt.com/dbt/manifest/v9.json";
    @SerializedName("dbt_version")
    @Expose
    private String dbtVersion = "1.6.0a1";
    @SerializedName("generated_at")
    @Expose
    private Date generatedAt = new Date(1682075346496L);
    @SerializedName("invocation_id")
    @Expose
    private Object invocationId = null;
    @SerializedName("env")
    @Expose
    private Env__11 env;
    /**
    ...
    private final static long serialVersionUID = 4065882074731553608L;
    ...
    public Env__11 getEnv() {
        return env;
    }

    public void setEnv(Env__11 env) {
        this.env = env;
    }
    ...
    public String toString() {
        ...
        sb.append(ManifestMetadata__9 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ManifestMetadata__9) == false) {
            return false;
        }
        ManifestMetadata__9 rhs = ((ManifestMetadata__9) other);
