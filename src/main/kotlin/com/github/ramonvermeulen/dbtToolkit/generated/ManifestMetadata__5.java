...
public class ManifestMetadata__5 implements Serializable
{

    @SerializedName("dbt_schema_version")
    @Expose
    private String dbtSchemaVersion = "https://schemas.getdbt.com/dbt/manifest/v5.json";
    @SerializedName("dbt_version")
    @Expose
    private String dbtVersion = "1.1.0b1";
    @SerializedName("generated_at")
    @Expose
    private Date generatedAt = new Date(1649726192489L);
    ...
    private final static long serialVersionUID = -6117262226290603082L;
    ...
    public Env__7 getEnv() {
        return env;
    }

    public void setEnv(Env__7 env) {
        this.env = env;
    }
    ...
    public String toString() {
        ...
        sb.append(ManifestMetadata__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ManifestMetadata__5) == false) {
            return false;
        }
        ManifestMetadata__5 rhs = ((ManifestMetadata__5) other);
