...
public class ManifestMetadata__8 implements Serializable
{

    @SerializedName("dbt_schema_version")
    @Expose
    private String dbtSchemaVersion = "https://schemas.getdbt.com/dbt/manifest/v8.json";
    @SerializedName("dbt_version")
    @Expose
    private String dbtVersion = "1.4.1";
    @SerializedName("generated_at")
    @Expose
    private Date generatedAt = new Date(1675937087350L);
    ...
    private final static long serialVersionUID = 24803173521860897L;
    ...
    public Env__10 getEnv() {
        return env;
    }

    public void setEnv(Env__10 env) {
        this.env = env;
    }
    ...
    public String toString() {
        ...
        sb.append(ManifestMetadata__8 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ManifestMetadata__8) == false) {
            return false;
        }
        ManifestMetadata__8 rhs = ((ManifestMetadata__8) other);
