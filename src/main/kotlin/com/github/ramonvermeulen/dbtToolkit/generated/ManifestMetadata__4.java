...
public class ManifestMetadata__4 implements Serializable
{

    @SerializedName("dbt_schema_version")
    @Expose
    private String dbtSchemaVersion = "https://schemas.getdbt.com/dbt/manifest/v4.json";
    @SerializedName("dbt_version")
    @Expose
    private String dbtVersion = "1.0.0rc2";
    @SerializedName("generated_at")
    @Expose
    private Date generatedAt = new Date(1638236147307L);
    ...
    private final static long serialVersionUID = -6867232934437289558L;
    ...
    public Env__6 getEnv() {
        return env;
    }

    public void setEnv(Env__6 env) {
        this.env = env;
    }
    ...
    public String toString() {
        ...
        sb.append(ManifestMetadata__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ManifestMetadata__4) == false) {
            return false;
        }
        ManifestMetadata__4 rhs = ((ManifestMetadata__4) other);
